...
import com.dzejju.ordering_app.OrderingAppApplication;
...
public class FillDatabaseDoSkasowania {


    private static final Logger log = LoggerFactory.getLogger(OrderingAppApplication.class);
